...
#define TOTP_ROLL_VALUE_FN_HEADER(type, step_type) void totp_roll_value_##type(type* value, step_type step, type min, type max, TotpRollValueOverflowBehavior overflow_behavior)
