...
static constexpr auto app_api_table = sort(create_array_t<sym_entry>(
    ...
    API_METHOD(totp_config_get_token_iterator_context, TokenInfoIteratorContext*, (const PluginState*)),
    API_METHOD(totp_config_file_backup, char*, (const PluginState*)),
    API_METHOD(totp_config_file_update_encryption, bool, (PluginState*, uint8_t, const uint8_t*, uint8_t)),
    ...
    API_METHOD(totp_token_info_iterator_get_current_token_index, size_t, (const TokenInfoIteratorContext*)),
    API_METHOD(totp_token_info_iterator_go_to, bool, (TokenInfoIteratorContext*, size_t)),
    API_METHOD(totp_token_info_iterator_get_current_token, const TokenInfo*, (const TokenInfoIteratorContext*)),
    API_METHOD(totp_token_info_iterator_add_new_token, TotpIteratorUpdateTokenResult, (TokenInfoIteratorContext*, TOTP_ITERATOR_UPDATE_TOKEN_ACTION, const void*)),
    API_METHOD(totp_token_info_iterator_update_current_token, TotpIteratorUpdateTokenResult, (TokenInfoIteratorContext*, TOTP_ITERATOR_UPDATE_TOKEN_ACTION, const void*)),
    API_METHOD(totp_token_info_iterator_move_current_token_info, bool, (TokenInfoIteratorContext*, size_t)),
    API_METHOD(totp_token_info_iterator_remove_current_token_info, bool, (TokenInfoIteratorContext*)),
    ...
    API_METHOD(token_info_set_secret, bool, (TokenInfo*, const char*, size_t, PlainTokenSecretEncoding, const CryptoSettings*)),
